...
_lr_productions = [
  ...
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',148),
  ('items -> item items','items',2,'p_items','yacc.py',152),
  ('items -> empty','items',1,'p_items_empty','yacc.py',156),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',160),
  ('item -> atom','item',1,'p_item_atom','yacc.py',164),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',172),
  ('item -> call','item',1,'p_item_call','yacc.py',176),
  ('item -> empty','item',1,'p_item_empty','yacc.py',180),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',184),
